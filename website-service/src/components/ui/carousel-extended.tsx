...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square h-24 w-full rounded-md opacity-40 transition-opacity ${
          isSlideActive ? "!opacity-100" : "hover:opacity-75"
        }`}
      >
        {children}
      </div>
    ...
    return (
      <Button
        ...
        className={cn(
          ...
          orientation === "vertical" ? "-top-2 left-1/2 -translate-x-1/2 rotate90" : "-left-2 top-1/2 -translate-y-1/2",
          className
        )}
        onClick={scroll}
        disabled={!canScroll}
      ...
      <Button
        ...
        className={cn(
          ...
          orientation === "vertical"
            ? "-bottom-2 left-1/2 -translate-x-1/2 rotate90"
